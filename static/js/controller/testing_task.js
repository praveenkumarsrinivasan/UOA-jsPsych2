...
var testing_task_exp = function(appModel) {
    ...
    var images_block = {
        ...
        is_html: true,
        // timing_response: exp_configCollection.at(0).attributes.test_image_timing_response,
        timing_post_trial: appModel.attributes.exp_configCollection.at(0).attributes.test_timing_post_trial,
        choices: [49, 50, 51]
            // response_ends_trial: false
    };
    ...
    var getAverageResponseTime = function() {
        ...
        var current_trial = 0;
        if (trials.length > 0) {
            current_trial = trials.length - appModel.attributes.exp_configCollection.at(0).attributes.test_slider_timing_trials.length;
        }
