...
var thanks_task_exp = function(appModel) {
    ...
    if (appModel.attributes.total_points>=5 && appModel.attributes.total_points<=35) {
        payment_code = '4';
    } else if (appModel.attributes.total_points>35 && appModel.attributes.total_points <= 45) {
        payment_code = '4.5';
    } else if (appModel.attributes.total_points>45) {
        payment_code = '5';
    } else {
        payment_code = '0.20';
    }
    ...
    var thanks_task_template = _.template(appModel.attributes.thanks_task);
